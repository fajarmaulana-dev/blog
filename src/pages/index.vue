...
onMounted(() => {
    ...
    typer('#typer')
        ...
        .continue('a MEVN Stack Developer').pause(4000).back('all')
        .continue('a TensorFlow Developer').pause(4000).back('all')
        .repeat(Infinity)
})
...
<template>
    ...
    <div class="min-h-screen bg-[rgb(10,25,47)] px-7 sd:px-10 sm:px-28 lg:px-40 pb-4">
        ...
        <div :class="loading ? 'bottom-0 opacity-100' : '-bottom-full opacity-30'"
