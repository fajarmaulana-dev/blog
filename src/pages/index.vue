...
const project: Record<string, any>[] = [
    { name: 'Komlabs.id', image: 'https://storage.googleapis.com/komerce/Komlabs/herosection.png', desc: 'Multi-Channel Network untuk membantu pengelolaan creator melalui kontrak eksklusif dalam jangka waktu tertentu dengan sistem bagi hasil.', tech: ['React.js', 'TypeScript', 'PWA', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://komlabs.id', email: '', pass: '' },
    ...
    { name: 'Komtim - Talent Pool', image: getAssets('talent-pool.avif'), desc: 'Komtim - Talent Pool is a page used to promote all talent in Komtim. The core web vitals of this landing page has been improved as part of the task.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/admin-marketplace', email: '', pass: '' },
