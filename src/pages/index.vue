...
const tech = [
    ...
    ['Nuxt.js', 'PWA', 'TensorFlow', 'FastAPI', 'Cloudinary', 'Beautiful Soup', 'Websocket']
]
const work_data: Record<string, string> = {
    'Bank Indonesia - Apr/2026 (Present)': 'Here I got a part to work on a project called Digital Workplace (DWP) with Vue.js which is an information system developed to support decision-making as directed by the Board of Governors.',
    'Komerce - June/2024': 'In this company, I was responsible for handling Komtim and Komplace products. Komtim is a talent service provider of Customer Service, Advertiser, Marketplace Admin, and Livestreamer to help MSME businesses in need. While Komplace is a product management service provider in many stores, order processing in all marketplaces, stock synchronization, and customer chat reply in one application. In addition, I also have the responsibility to revamp and improve landing page performance for several products, as well as doing bug fixing.',
...
const project: Record<string, any>[] = [
    { name: 'Komerce Live Chat', image: getAssets('livechat.avif'), desc: "Commercial Live Chat is a live chat dashboard and widget with customizable features tailored to a company's needs. Besides reducing costs compared to using third-party services, creating your own live chat also allows for more flexible customization of features and appearance, especially for agents. Agent-side security is enhanced with Strict Cookie and Strict CSP Config.", tech: ['React.js', 'TypeScript', 'PWA', 'TailwindCSS', 'Web Socket', 'Shadcn'], secret: true, done: true, git: '', url: 'https://agent.komerce.id', email: '', pass: '' },
    { name: 'Komtim.id - Influencer', image: getAssets('komtim-influencer.avif'), desc: 'Komtim - Influencer is a landing page used to promote reliable influencer from Komlabs Ecosystem.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/influencer', email: '', pass: '' },
    { name: 'Komlabs.id', image: 'https://storage.googleapis.com/komerce/Komlabs/herosection.png', desc: 'Multi-Channel Network to help creator management through exclusive contracts for a certain period with a profit-sharing system.', tech: ['React.js', 'TypeScript', 'PWA', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://komlabs.id', email: '', pass: '' },
    { name: 'Komcards.id', image: getAssets('komcards.avif'), desc: 'Komcards is an innovative virtual debit card management platform developed by PT Kampung Marketerindo Berdaya, a registered Electronic System Provider (PSE) with the Indonesian Ministry of Communication and Information Technology (Kominfo). Komcards does not operate independently in providing financial services products regulated by law. Instead, it collaborates with licensed and regulated payment gateway companies and domestic bank partners supervised by the Financial Services Authority (OJK) of the Republic of Indonesia. Card issuance and fund storage are handled by the relevant bank partners.', tech: ['React.js', 'TypeScript', 'PWA', 'TailwindCSS', 'Partytown'], secret: true, done: true, git: '', url: 'https://komcards.id', email: '', pass: '' },
    { name: 'Komship.id', image: getAssets('komship.avif'), desc: 'Komship was created to help online sellers easily manage and ship their COD and non-COD packages through various courier services from a single platform, while offering exclusive benefits such as discounted shipping rates, free return fees across Indonesia, and the flexibility of sending packages without minimum shipment requirements. This page is built with Next.js App Router without any additional libraries when initiated to support good Core Web Vitals.', tech: ['Next.js', 'TypeScript', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://komship.id', email: '', pass: '' },
    { name: 'RajaOngkir', image: getAssets('rajaongkir.avif'), desc: 'RajaOngkir is a service that provides shipping cost information, as well as Open API for shipping goods and COD for various couriers in Indonesia such as POS Indonesia, JNE, TIKI, J&T, IDexpress, SAP, Ninja, and SiCepat. This Landing Page is built with Next.js App Router without any additional libraries when initiated to support good Core Web Vitals.', tech: ['Next.js', 'TypeScript', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://rajaongkir.com', email: '', pass: '' },
    { name: 'Komtim.id', image: getAssets('komtim.avif'), desc: 'Komtim is a talent service provider of Customer Service, Advertiser, Marketplace Admin, and Livestreamer to help MSME businesses in need.  Created above Nuxt.js with improved Core Web Vital Scores.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id', email: '', pass: '' },
    { name: 'Komtim - Customer Service', image: getAssets('komtim-customer-service.avif'), desc: 'Komtim - Customer Service is a landing page used to promote reliable customer service talents who have been fostered by Komtim.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/customer-service', email: '', pass: '' },
    { name: 'Komtim - Livestreamer', image: getAssets('komtim-livestreamer.avif'), desc: 'Komtim - Livestreamer is a landing page used to promote reliable live streamer talents who have been fostered by Komtim.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/livestreamer', email: '', pass: '' },
    { name: 'Komtim - Advertiser', image: getAssets('komtim-advertiser.avif'), desc: 'Komtim - Advertiser is a landing page used to promote reliable advertiser talents who have been fostered by Komtim.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/advertiser-package', email: '', pass: '' },
    { name: 'Komtim - Admin Marketplace', image: getAssets('komtim-admin-marketplace.avif'), desc: 'Komtim - Admin Marketplace is a landing page used to promote reliable admin marketplace talents who have been fostered by Komtim.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/admin-marketplace', email: '', pass: '' },
    { name: 'Komtim - Talent Pool', image: getAssets('talent-pool.avif'), desc: 'Komtim - Talent Pool is a page used to promote all talent in Komtim.', tech: ['Nuxt.js', 'JavaScript'], secret: true, done: true, git: '', url: 'https://komtim.id/admin-marketplace', email: '', pass: '' },
    ...
    { name: 'Komerce Admin', image: getAssets('admin.avif'), desc: 'Komerce Admin is a web app to manage and monitor all product development in Komerce. The web app is built with Vue.js.', tech: ['Vue.js', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://my.komerce.id', email: '', pass: '' },
    { name: 'Komerce Partner', image: getAssets('partner.avif'), desc: 'Komerce Partner was created to enable all partners of Komerce to collaborate with Komerce. The web app is built with Vue.js and Next.js in migration process by using micro frontend architecture.', tech: ['Vue.js', 'TailwindCSS'], secret: true, done: true, git: '', url: 'https://partner.komerce.id', email: '', pass: '' },
